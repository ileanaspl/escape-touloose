...
export function home() {
  ...
  paragraphrdj.innerText =
    "Vous voici sur un escape game sur le thème de la ville de Toulouse, le score dépend de plusieurs critères : le nombre de bonnes réponses, la rapidité des réponses. Attention aux mauvaises réponses. Bon courage ! ";
  ...
  const nameInput = createElementWithAttribute("input", {
    type: "text",
    id: "name-input",
